...
public class BatteryCapacity : MonoBehaviour
{
    ...
    int contrast;
    string switchValue;
    //Debug.Log("TelemetryController.suitSwitch.vent_error" + TelemetryController.suitSwitch.vent_error);
    ...
    void Update()
    {
        if (TelemetryController.suitSwitch != null)
        {
            ...
            else if (TelemetryController.battery_capacity_critical || switchValue == "0")
